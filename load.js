...
switch (theme) {
    case "dark":
        ...
        document.documentElement.style.setProperty('--blurOverlay', "rgba(255, 255, 255, 0.12)");
        break;
    case "light":
        document.documentElement.style.setProperty('--main', "whitesmoke");
        document.documentElement.style.setProperty('--accent', "black");
        document.documentElement.style.setProperty('--accent1', "#DEDEDE");
        document.documentElement.style.setProperty('--blurOverlay', "rgba(0, 0, 0, 0.25)");
        break;
}
...
function addToList (e) {
    ...
    list += '<tr>';
    list += '<td>';
    list += '<iframe src="'+e.cover+'" class="cover" seamless="seamless"></iframe>';
    list += '</td>';
    list += '<td style="width: 100%; text-align: left;">';
